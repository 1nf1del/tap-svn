...
//-------------------------------
// Global variables
static byte keyboardListType = 0;
static dword lastCursorBlink = 0;
static dword lastRemoteKeyDigit = 0;
static bool savedFlash = 0;
...
static byte* keyboardWindowCopy = NULL;
static byte* keyboardHelpWindowCopy = NULL;
static int glbMaxChars = 0;  // Maximum number of characters that can be entered.
...
static bool remoteKeyActive = 0;                                            // Is there a digit key character active awaiting timeout?
static word keyboardRgn = 0;												// a memory region used for our text string.
...
{
	dword 	x_coord = 0, y_coord = 0, max = 0, width = 0, totalWidth = 0;
	char	str[256];
	char	letter = 0;
	int 	len = 0, i = 0, startPos = 0, endPos = 0;
	bool    charactersToLeft = 0, charactersToRight = 0;
...
{
	char	str[256];
	int	len = 0, i = 0, tempInsertMode = 0;
	bool    bLowerCase = 0;
...
{
    int		keyindex = 0, currInsertMode = 0;
    char	keychar = 0;
