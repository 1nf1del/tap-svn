========================================================================
    STATIC LIBRARY : libtapulator Project Overview
========================================================================

AppWizard has created this libtapulator library project for you. 
This file contains a summary of what you will find in each of the files that
make up your libtapulator application.
...
StdAfx.h, StdAfx.cpp
    ...
    named libtapulator.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "libtapulator.rc" and a "libtapulator.h" that 
